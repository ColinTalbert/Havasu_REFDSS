...
Friend Class clsMathParser
    ...
    Const Oper As String = "+ - * / % \ ^ > >= < <= = <>" 'EAC: never used here
            ...
            With ET(k)
                ...
                Select Case .FunTok
                    ...
                    Case symStep : ris = Step_(a, b)
                        ' > Berend 20041216
                        ' > not clear form me EAC 20090517
                    Case symYear : ris = DateAndTime.Year(Date.FromOADate(a))
                    Case symMonth : ris = DateAndTime.Month(Date.FromOADate(a))
                    Case symDay : ris = DateAndTime.Day(Date.FromOADate(a))
                    Case symHour : ris = DateAndTime.Hour(Date.FromOADate(a))
                    Case symMinute : ris = DateAndTime.Minute(Date.FromOADate(a))
                    Case symSecond : ris = DateAndTime.Second(Date.FromOADate(a))
                        ' < Berend 20041216
                    Case Is > HFOffset
