...
#Region "Private Variables"
    ...
    Private _MouseWheelDivisor As Integer = 3000
    ...
    Private _HasZoomed As Boolean = False
#End Region
...
#End Region
    ...
    Public Sub SetZoomBounds(rect As Rectangle)
...
#Region "Private methods"
    ...
    Private Sub ResizeForm()
        If _imageInitialized And _Image IsNot Nothing Then
            If Not _HasZoomed Then
    ...
    Private Function PreserveImageBounds() As Rectangle
        Dim w As Integer = CInt(_Image.Width)
        Dim h As Integer = CInt(_Image.Height)
        Dim x As Integer = (Me.ClientSize.Width - w) \ 2
        Dim y As Integer = (Me.ClientSize.Height - h) \ 2
        Return New Rectangle(x, y, w, h)
    End Function
